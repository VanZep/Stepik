...
проста и проиллюстрирована на рисунке pictures/8.png.
...
На рисунке минимальный элемент - это 2, поэтому менять местами здесь ничего не
...
lst = [8, 11, -53, 2, 10, 11]
lst_2 = [8, 11, -53, 2, 10, 11, 0, 0, 0]
lst_3 = [8, 11, -53, 2, 10, 11, 0, 0, 0]
lst_4 = [8, 11, -53, 2, 10, 11, 0, 0, 0]

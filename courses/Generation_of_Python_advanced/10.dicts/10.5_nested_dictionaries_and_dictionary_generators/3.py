...
result, состоящий из всех элементов словаря favorite_numbers, значения которых
являются двузначными числами.
"""
...
result = {
    key: value for key, value in favorite_numbers.items()
    if 9 < value < 100
}

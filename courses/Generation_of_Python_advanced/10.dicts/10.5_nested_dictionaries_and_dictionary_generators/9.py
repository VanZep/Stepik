"""
В переменной students хранится словарь, содержащий информацию о росте (в см)
...
result = {
    item: students[item] for item in students
    if students[item][0] > 167 and students[item][1] < 75
}

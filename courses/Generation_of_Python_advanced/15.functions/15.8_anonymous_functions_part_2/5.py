...
выводит слова из списка words, имеющие длину ровно 6 символов. Слова следует
вывести в алфавитном порядке на одной строке, отделяя символом пробела.
"""
...
words = [
    ...
    'benevolent', 'abate', 'abide', 'bicycle', 'beside', 'accept', 'berry',

...
заданного списка numbers трехзначные числа, дающие при делении на 5 остаток 2,
и выводит их кубы, каждый на отдельной строке.
"""
...
numbers = [
    ...
    351, 1439, 186, 273, 1008, 231, 138, 142, 433, 456, 1268, 1018, 1274,
    387, 120, 340, 963, 832, 1127
]

filtered_numbers = filter(lambda x: 99 < x < 1000 and x % 5 == 2, numbers)

print(*map(lambda x: x ** 3, filtered_numbers), sep='\n')

...
командой:
line = LineTo(x, y)
где x, y - следующая координата линейного участка (начало маршрута из точки 0,
0).
...
сегментов)
add_line(self, line) - добавление нового линейного сегмента (объекта класса
LineTo) в конец маршрута
...
class PathLines:
    ...
    def get_length(self):
        ...
        for line in self.path:
            length += sqrt(pow(line.x - x, 2) + pow(line.y - y, 2))
            x, y = line.x, line.y

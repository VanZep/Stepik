...
Значения a, b, c должны сохраняться в локальных приватных атрибутах __a, __b,
__c объектах этого класса.
...
class Dimensions:
    ...
    @classmethod
    def value_validator(cls, value: int) -> bool:
        return (
                type(value) == int

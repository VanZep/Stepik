...
различных тегов, включая теги <img>. Код должен находить все теги <img> и
суммировать значения их атрибута alt.

Задача:
Обработать все теги <img> в предоставленной HTML-строке.
Извлечь значение атрибута alt для каждого тега <img>. Предполагается, что
значения этого атрибута представляют собой целые числа.

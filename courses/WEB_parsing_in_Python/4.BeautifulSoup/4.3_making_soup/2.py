"""
Цель:
Написать код, который будет обрабатывать предоставленную HTML-структуру,
представляющую собой карточку товара. Код должен находить тег <p> с классом
card-description и извлекать из него текстовое описание товара.
